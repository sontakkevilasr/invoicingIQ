    ...
    <div class="page-head flex justify-between items-center">
        <div>
            ...
            <div class="page-subtitle">
                <?php echo e(\Carbon\Carbon::parse($from)->format('d M Y')); ?>

                &nbsp;—&nbsp;
                <?php echo e(\Carbon\Carbon::parse($to)->format('d M Y')); ?>
        ...
        <div class="card" style="margin-bottom:18px;">
            ...
            <div class="table-wrap">
                <table class="tbl">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['b2b']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
        ...
        <div class="card">
            ...
            <div class="table-wrap">
                <table class="tbl">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['b2c']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(route('invoices.edit', $r['id'])); ?>" style="color:var(--accent);font-weight:600;text-decoration:none;"><?php echo e($r['number']); ?></a></td>
                            <td style="color:var(--t3);"><?php echo e($r['date']); ?></td>
                            <td style="font-weight:500;"><?php echo e($r['customer'] ?: '—'); ?></td>
    ...
    <?php elseif($report === 'hsn'): ?>
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:11px;color:var(--t4);"><?php echo e($data['rows']->count()); ?> HSN codes</span>
            </div>
            <?php if($data['rows']->count()): ?>
            <div class="table-wrap">
                <table class="tbl">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="r" style="font-weight:500;"><?php echo e(fmt_inr($r->total_taxable)); ?></td>
                            <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($r->total_cgst)); ?></td>
                            <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($r->total_sgst)); ?></td>
                            <td class="r" style="color:var(--warn);"><?php echo e(fmt_inr($r->total_igst)); ?></td>
                            <td class="r" style="font-weight:500;"><?php echo e(fmt_inr($r->total_tax)); ?></td>
                            <td class="r" style="font-weight:600;"><?php echo e(fmt_inr($r->total_amount)); ?></td>
            ...
            <div class="card">
                ...
                <div class="table-wrap">
                    <table class="tbl">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data['byRate']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><span class="badge badge-blue"><?php echo e($r->gst_rate); ?>%</span></td>
                                <td class="r"><?php echo e(fmt_inr($r->taxable)); ?></td>
                                <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($r->cgst)); ?></td>
                                <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($r->sgst)); ?></td>
                                <td class="r" style="color:var(--warn);"><?php echo e(fmt_inr($r->igst)); ?></td>
                                <td class="r" style="font-weight:600;"><?php echo e(fmt_inr($r->total_tax)); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                        <tfoot style="background:var(--s2);">
        ...
        <div class="card">
            ...
            <div class="table-wrap">
                <table class="tbl">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data['monthly']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="font-weight:500;"><?php echo e($m->month_label); ?></td>
                            <td class="r" style="color:var(--t3);"><?php echo e($m->inv_count); ?></td>
                            <td class="r"><?php echo e(fmt_inr($m->taxable)); ?></td>
                            <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($m->cgst)); ?></td>
                            <td class="r" style="color:var(--accent);"><?php echo e(fmt_inr($m->sgst)); ?></td>
                            <td class="r" style="color:var(--warn);"><?php echo e(fmt_inr($m->igst)); ?></td>
                            <td class="r" style="font-weight:600;"><?php echo e(fmt_inr($m->total_tax)); ?></td>
                            <td class="r" style="font-weight:600;"><?php echo e(fmt_inr($m->grand)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot style="background:var(--s2);">
    ...
    <?php elseif($report === 'b2b'): ?>
        <div class="card">
            <div class="card-header">
                ...
                <span style="font-size:11px;color:var(--t4);"><?php echo e($data['rows']->count()); ?> registered customers</span>
            </div>
            <?php if($data['rows']->count()): ?>
            <div class="table-wrap">
                <table class="tbl">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\invoiceiq\resources\views/reports/gst.blade.php ENDPATH**/ ?>